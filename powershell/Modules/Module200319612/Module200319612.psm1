...
# Function to get a summary of the RAM installed with the vendor, description, size, and bank and slot for each DIMM as a table and the total RAM installed 
# in the computer as a summary line after the table
